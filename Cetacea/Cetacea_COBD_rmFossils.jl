...
f_epoch  = Int64[0]
niter    = veryShortMCMC ? 10 : (shortMCMC ? 10_000 : 50_000_000)
...
ofile    = "COBD_rmFossils_Cetaceans_$(niter)iter_seed$(seed_nb)" ; isdir("outputs/") || mkdir("outputs/")
ϵi       = 0.4
λi       = NaN
μi       = NaN
ψi       = 0.0
ωi       = NaN
# pupdp    = (0.02, 0.02, 0.0, 0.01, 0.1)
pupdp    = (0.02, 0.02, 0.0, 0.01, 0.5)
survival = true
prints   = 5
mxthf    = 0.05
tρ       = Dict("" => 1.0)
